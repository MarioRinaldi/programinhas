...
void change(int choice, char** file_name) {
    ...
    switch (choice) {
        case 1:
            puts("voce escolheu dev da equipe Amarela");
            *file_name = "hosts.dev.amarela";
            break;
        case 2:
            puts("voce escolheu homol da equipe Amarela");
            *file_name = "hosts.homol.amarela";
            break;
        case 3:
            puts("voce escolheu dev da equipe Verde");
            *file_name = "hosts.dev.verde";
            break;
        case 4:
            puts("voce escolheu homol da equipe Verde");
            *file_name = "hosts.homol.verde";
            break;
        case 5:
